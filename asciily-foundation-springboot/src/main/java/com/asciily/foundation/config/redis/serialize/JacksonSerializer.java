package com.asciily.foundation.config.redis.serialize;
...
public class JacksonSerializer implements RedisSerializer<Object> {
	...
	/**
	 * Creates {@link GenericJackson2JsonRedisSerializer} and configures {@link ObjectMapper} for default typing using the given
	 * {@literal name}. In case of an {@literal empty} or {@literal null} String the default {@link JsonTypeInfo.Id#CLASS} will be used.
	 * 
	...
	/**
	 * Setting a custom-configured {@link ObjectMapper} is one way to take further control of the JSON serialization process. For example,
	 * an extended {@link SerializerFactory} can be configured that provides custom serializers for specific types.
	 * 
	 * @param mapper
	...
	public Object deserialize(byte[] source) throws SerializationException {
		Object rs = deserialize(source, Object.class);
		return rs;
	}
