 ...
 */
package com.bubble.foundation.datagram.response;
...
import com.bubble.foundation.common.util.DateUtil;
import com.bubble.foundation.common.util.digest.AesRsaUtil;
import com.bubble.foundation.common.util.digest.Des3Util;
import com.bubble.foundation.datagram.AbstractDatagram;
import com.bubble.foundation.datagram.ResponseInfo;
...
public class ResponseDatagram extends AbstractDatagram {
	...
	public ResponseDatagram decryptRSA(String encryptString, String privateKey) throws DatagramException {
		try {
			...
			this.setExtras(rsd.getExtras());
			byte[] aesKeyByte = AesRsaUtil.decryptKey(privateKey, rsd.getSignature(), "UTF-8");
			this.setData(BeanUtil.json2Bean(AesRsaUtil.decryptData((String) rsd.getData(), aesKeyByte, "UTF-8"), Map.class));
